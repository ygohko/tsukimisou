...
void main() {
  ...
  group('BindingTagsPage', () {
    testWidgets('BindingTagsPage should have specified widgets.', (WidgetTester tester) async {
        final memo = Memo();
    ...
    testWidgets('BindingTagsPage should add tags to memo.', (WidgetTester tester) async {
        final memo = Memo();
        memo.text = 'This is a test.';
        memo.tags = ['a', 'b', 'c'];
        await init(tester, memo);
    ...
    testWidgets('BindingTagsPage should remove tags from memo.', (WidgetTester tester) async {
        final memo = Memo();
        memo.text = 'This is a test.';
        memo.tags = ['a', 'b', 'c'];
        await init(tester, memo);
