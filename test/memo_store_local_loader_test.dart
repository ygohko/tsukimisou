...
void main() {
  ...
  group('MemoStoreLocalLoader', () {
    ...
    test('MemoStoreLocalLoader should load memos from version 1 JSON.', () async {
    ...
    test('MemoStoreLocalLoader should load memos from version 2 JSON.', () async {
      var file = File('./test.json');
      await file.writeAsString(
    ...
    test('MemoStoreLocalLoader should load memos from version 3 JSON.', () async {
      var file = File('./test.json');
      await file.writeAsString(
